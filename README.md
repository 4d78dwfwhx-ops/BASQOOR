...
- 🏭 قطع غيار أصلية (OEM)
- ⚙️ قطع غيار بديلة (Aftermarket)
- 🔄 قطع غيار مستعملة
- 🔧 قطع غيار التشاليح
- 🚗 سيارات كاملة
- 🔨 ورش صيانة معتمدة
- 🚨 خدمة SOS للطوارئ 24/7
...
@layer components {
  ...
  ::-webkit-scrollbar-thumb {
    background: linear-gradient(180deg, #D4A853, #F9C633);
    border-radius: 10px;
  }

  ::-webkit-scrollbar-thumb:hover {
    background: linear-gradient(180deg, #F9C633, #D4A853);
  }
