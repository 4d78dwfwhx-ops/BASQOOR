      ...
      <section className="py-24 bg-dark-900/50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <FeatureCard icon={Shield} title="تجار موثوقون" description="جميع التجار معتمدون وموثقون مع نظام تقييم شفاف" color="amber" />
            <FeatureCard icon={Zap} title="توصيل سريع" description="شحن خلال 24 ساعة مع تتبع مباشر للطلبات" color="emerald" />
            <FeatureCard icon={Truck} title="SOS على الطريق" description="مساعدة فورية على مدار الساعة في أي مكان" color="crimson" />
            <FeatureCard icon={Star} title="تقييمات حقيقية" description="مراجعات من عملاء حقيقيين مع صور" color="azure" />
            <FeatureCard icon={Search} title="بحث ذكي" description="ابحث بالـ VIN أو رقم القطعة أو الوصف" color="purple" />
            <FeatureCard icon={Award} title="ضمان الجودة" description="جميع القطع مفحوصة ومضمونة" color="amber" />
          </div>
        </div>
      </section>
...
function FeatureCard({ icon: Icon, title, description, color }: any) {
  const colorClasses: any = {
    ...
    crimson: "bg-red-500/10 text-red-400",
