      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-gray-400 max-w-2xl mx-auto">
            اكتشف ملايين القطع والخدمات في مكان واحد
          </p>
        </motion.div>
          ...
          {categories.map((category, index) => (
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <h3 className="font-bold text-base mb-2 text-white group-hover:text-gold transition-colors">
                  {category.name}
                </h3>
        ...
        >
          <button className="btn-secondary py-4 px-10 rounded-xl text-lg inline-flex items-center gap-2">
