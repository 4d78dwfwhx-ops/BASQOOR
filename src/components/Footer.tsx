        ...
        <div className="grid lg:grid-cols-5 gap-12 mb-12">
          ...
          >
            <div className="flex items-center gap-3 mb-6">
              <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-gold to-gold-light flex items-center justify-center glow-gold">
                <span className="text-dark-950 font-black text-2xl">ب</span>
              </div>
              <div>
                <h3 className="text-3xl font-black gradient-text">بسكور</h3>
                <p className="text-xs text-gray-400">BASQOR</p>
              </div>
            </div>
            <p className="text-gray-400 leading-relaxed mb-6 max-w-md">
              منصة BASQOR المتكاملة لقطع الغيار والسيارات في المملكة العربية
              السعودية. كل قطعة. كل مكان. بثقة.
            </p>

            {/* Contact Info */}
            <div className="space-y-3 mb-6">
              <a
                href="mailto:info@basqor.sa"
                className="flex items-center gap-3 text-gray-400 hover:text-gold transition-colors"
              >
                <Mail className="w-4 h-4" />
                <span>info@basqor.sa</span>
              </a>
              <a
            ...
            <div className="flex gap-3">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="w-10 h-10 rounded-xl glass flex items-center justify-center text-gray-400 hover:text-gold hover:border-gold/30 transition-all duration-300"
                >
