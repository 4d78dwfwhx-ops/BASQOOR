      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center max-w-5xl mx-auto">
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full glass border border-gold/30 mb-8"
          >
          ...
          <motion.h1
            ...
            className="text-5xl sm:text-6xl lg:text-8xl font-black mb-8 leading-[1.1]"
          >
          ...
          >
            منصة BASQOR المتكاملة لقطع الغيار والسيارات في المملكة العربية
            السعودية
          </motion.p>
          ...
          >
            <div className="glass-strong rounded-2xl p-2 flex flex-col sm:flex-row gap-2">
              <div className="flex-1 flex items-center gap-3 px-5 py-4">
                ...
                <input
                  ...
                  className="flex-1 bg-transparent border-none outline-none text-white placeholder:text-gray-500 text-right text-lg"
                />
              </div>
            ...
            <div className="flex flex-wrap gap-2 justify-center mt-4">
              {["تويوتا كامري", "فرامل", "بطارية", "زيت محرك"].map((tag) => (
                <button
                  key={tag}
                  className="px-4 py-1.5 rounded-full text-sm glass text-gray-300 hover:text-gold hover:border-gold/30 transition-all"
                >
                  {tag}
                </button>
              ))}
          ...
          <motion.div
            ...
            className="grid grid-cols-2 sm:grid-cols-4 gap-6 max-w-4xl mx-auto mb-12"
          >
          ...
          >
            <button className="btn-primary py-4 px-10 rounded-xl text-lg">
              ابدأ التسوق الآن
            </button>
            <button className="btn-secondary py-4 px-10 rounded-xl text-lg">
              سجل ورشتك
            </button>
          </motion.div>
        </div>
